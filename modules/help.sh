...
citadel_help() {
    ...
    while true; do
        ...
        echo -e "${VIO}╠══════════════════════════════════════════════════════════════╣${NC}"
        echo -e "${VIO}║${NC} ${GREEN}[1]${NC} ${T_HELP_MENU_1:-1. Installation}$(printf '%*s' $((60 - 3 - ${#T_HELP_MENU_1})) '') ${VIO}║${NC}"
        echo -e "${VIO}║${NC} ${GREEN}[2]${NC} ${T_HELP_MENU_2:-2. Main Program}$(printf '%*s' $((60 - 3 - ${#T_HELP_MENU_2})) '') ${VIO}║${NC}"
        echo -e "${VIO}║${NC} ${GREEN}[3]${NC} ${T_HELP_MENU_3:-3. Add-ons}$(printf '%*s' $((60 - 3 - ${#T_HELP_MENU_3})) '') ${VIO}║${NC}"
        echo -e "${VIO}║${NC} ${GREEN}[4]${NC} ${T_HELP_MENU_4:-4. Advanced}$(printf '%*s' $((60 - 3 - ${#T_HELP_MENU_4})) '') ${VIO}║${NC}"
        echo -e "${VIO}║${NC} ${GREEN}[5]${NC} ${T_HELP_MENU_5:-5. Emergency}$(printf '%*s' $((60 - 3 - ${#T_HELP_MENU_5})) '') ${VIO}║${NC}"
        echo -e "${VIO}║${NC} ${YELLOW}[6]${NC} ${T_HELP_MENU_6:-6. All Commands}$(printf '%*s' $((60 - 3 - ${#T_HELP_MENU_6})) '') ${VIO}║${NC}"
        echo -e "${VIO}║${NC}$(printf '%*s' 60 '') ${VIO}║${NC}"
        echo -e "${VIO}║${NC} ${RED}[q]${NC} ${T_HELP_MENU_QUIT:-Quit}$(printf '%*s' $((60 - 3 - ${#T_HELP_MENU_QUIT})) '') ${VIO}║${NC}"
        echo -e "${VIO}╚══════════════════════════════════════════════════════════════╝${NC}"
        echo ""
