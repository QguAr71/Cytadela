...
citadel_help() {
    ...
    while true; do
        ...
        echo -e "${BLUE}╠══════════════════════════════════════════════════════════════╣${NC}"
        echo -e "${BLUE}║${NC} ${GREEN}[1]${NC} ${T_HELP_MENU_1:-1. Installation}                         ${BLUE}║${NC}"
        echo -e "${BLUE}║${NC} ${GREEN}[2]${NC} ${T_HELP_MENU_2:-2. Main Program}                       ${BLUE}║${NC}"
        echo -e "${BLUE}║${NC} ${GREEN}[3]${NC} ${T_HELP_MENU_3:-3. Add-ons}                            ${BLUE}║${NC}"
        echo -e "${BLUE}║${NC} ${GREEN}[4]${NC} ${T_HELP_MENU_4:-4. Advanced}                           ${BLUE}║${NC}"
        echo -e "${BLUE}║${NC} ${GREEN}[5]${NC} ${T_HELP_MENU_5:-5. Emergency}                        ${BLUE}║${NC}"
        echo -e "${BLUE}║${NC} ${YELLOW}[6]${NC} ${T_HELP_MENU_6:-6. All Commands}                     ${BLUE}║${NC}"
        echo -e "${BLUE}║${NC} ${RED}[q]${NC} ${T_HELP_MENU_QUIT:-Quit}                               ${BLUE}║${NC}"
        echo -e "${BLUE}╚══════════════════════════════════════════════════════════════╝${NC}"
        echo ""
