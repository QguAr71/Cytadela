...
citadel_help() {
    ...
    while true; do
        ...
        # Display menu header
        printf "${BLUE}╔══════════════════════════════════════════════════════════════╗${NC}\n"
        printf "${BLUE}║${NC} %-58s ${BLUE}║${NC}\n" "${CYAN}${T_HELP_MENU_TITLE:-CITADEL++ HELP - Select Section}${NC}"
        printf "${BLUE}╠══════════════════════════════════════════════════════════════╣${NC}\n"
        printf "${BLUE}║${NC} %-58s ${BLUE}║${NC}\n" "${GREEN}[1]${NC} ${T_HELP_MENU_1:-1. Installation}"
        printf "${BLUE}║${NC} %-58s ${BLUE}║${NC}\n" "${GREEN}[2]${NC} ${T_HELP_MENU_2:-2. Main Program}"
        printf "${BLUE}║${NC} %-58s ${BLUE}║${NC}\n" "${GREEN}[3]${NC} ${T_HELP_MENU_3:-3. Add-ons}"
        printf "${BLUE}║${NC} %-58s ${BLUE}║${NC}\n" "${GREEN}[4]${NC} ${T_HELP_MENU_4:-4. Advanced}"
        printf "${BLUE}║${NC} %-58s ${BLUE}║${NC}\n" "${GREEN}[5]${NC} ${T_HELP_MENU_5:-5. Emergency}"
        printf "${BLUE}║${NC} %-58s ${BLUE}║${NC}\n" "${YELLOW}[6]${NC} ${T_HELP_MENU_6:-6. All Commands}"
        printf "${BLUE}║${NC} %-58s ${BLUE}║${NC}\n" "${RED}[q]${NC} ${T_HELP_MENU_QUIT:-Quit}"
        printf "${BLUE}╚══════════════════════════════════════════════════════════════╝${NC}\n"
        echo ""
