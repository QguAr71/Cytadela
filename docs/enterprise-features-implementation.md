...
- Łączy się z istniejącymi metrykami z `monitor_prometheus_*` funkcji
- Rozszerza `citadel.sh monitor prometheus-*` komendy
...
- Aktualizuje nftables rules automatycznie co dzień via cron
...
### 4.2 High Availability (Keepalived)
