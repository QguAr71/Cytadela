...
export T_UNINSTALL_COMPLETE="Citadel został całkowicie usunięty. Aby przywrócić oryginalną konfigurację DNS, użyj polecenia: sudo ./citadel.sh emergency-network-restore"
export T_REINSTALL_CMD="Reinstalacja:  sudo ./citadel.sh install-wizard"
export T_IF_ISSUES_CMD="Problemy?:  sudo ./citadel.sh emergency-network-restore"
...
# Dodatki dla instalatora CLI (v3.3+)
export T_LANGUAGE_LOADED="Język załadowany"
...
export T_DRY_RUN_COMPLETE="Suchy bieg zakończony - nie wprowadzono zmian"
export T_STEP_MONITOR="Uruchom monitorowanie"
export T_STEP_STATUS="Sprawdź status"
export T_STEP_LOGS="Zobacz logi"
export T_STEP_UPDATE="Zaktualizuj listy blokad"
export T_LOG_FILE="Plik logu"

# Dodatki dla instalatora CLI (v3.3+)
export T_LANGUAGE_LOADED="Język załadowany"
export T_INSTALLER_TITLE="Instalator Citadel v3.3+ Enhanced CLI"
export T_WORKING_DIRECTORY="Katalog roboczy"
export T_LOG_FILE_LABEL="Plik logu"
export T_INSTALLATION_PLAN="Plan instalacji Citadel v3.3+"
export T_PROFILE="Profil"
export T_COMPONENTS="Komponenty"
export T_DRY_RUN="Suchy bieg"
export T_DRY_RUN_MODE_WARNING="TRYB PRÓBNY - Nie zostaną wprowadzone żadne zmiany"
export T_GUM_ENHANCED="Rozszerzony gum"
export T_BACKUP_EXISTING="Kopia zapasowa istniejących"
export T_SELECTED_COMPONENTS="Wybrane komponenty"
export T_PROCEED_WITH_INSTALLATION="Kontynuować instalację?"
export T_COMPONENT_DNSCRYPT="Szyfrowanie i cache DNS"
export T_COMPONENT_COREDNS="Serwer i filtrowanie DNS"
export T_COMPONENT_ADBLOCK="Blokowanie reklam przez DNS"
export T_COMPONENT_REPUTATION="Ocena reputacji IP"
export T_COMPONENT_ASN_BLOCKING="Blokowanie na poziomie sieci"
export T_COMPONENT_EVENT_LOGGING="Rejestrowanie zdarzeń strukturalnych"
export T_COMPONENT_HONEYPOT="Pułapki na skanery"
export T_COMPONENT_PROMETHEUS="Zbiór metryk"
export T_COMPONENT_FIREWALL="Reguły firewall NFTables"
export T_CHECKING_DEPS="Sprawdzanie zależności systemowych..."
export T_DEPENDENCIES_OK="Zależności OK"
export T_WOULD_CHECK_DEPS="Sprawdziłoby zależności"
export T_CONFIGURING_DNS="Konfigurowanie systemu DNS..."
...
export T_OPTIMIZING_KERNEL="Optymalizowanie priorytetów kernela"
...
export T_SELECT_ADDITIONAL_COMPONENTS="Wybierz dodatkowe komponenty"
export T_NO_ADDITIONAL_COMPONENTS="Brak dostępnych dodatkowych komponentów"
export T_SELECT_ADDITIONAL_TO_ADD="Wybierz dodatkowe komponenty do dodania:"
